function generateItem(title, desc, vacancy, location, date, time) {
    ...
    + itemTime
    + '</div>'
    + '<a href="./'+title+'"><div class="workshop-btn button btn-red">View</div></a>'
    + '</li>';
...
function generateItems(workshops){
    for(var i=0; i < workshops.length; i++){
        ...
        generateItem(workshop['title'], workshop['desc'], workshop['vacancy'], workshop['location'], workshop['date'], workshop['time']);    
    }
}
